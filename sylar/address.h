...
public:
    ...
    static IPAddress::ptr Create(const char* address, uint32_t  port = 0); // IPv4/IPv6 域名转 IP地址
...
public:
    ...
    static IPv4Address::ptr Create(const char* address, uint32_t port = 0);             // str -> sockaddr_in
